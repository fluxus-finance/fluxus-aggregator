...
use ref-router::{ContractContract as Exchange, ContractMetadata, PoolInfo};
use test_token::ContractContract as TestToken;

near_sdk_sim::lazy_static_include::lazy_static_include_bytes! {
    TEST_TOKEN_WASM_BYTES => "../res/test_token.wasm",
    PREV_EXCHANGE_WASM_BYTES => "../res/ref-router_131.wasm",
    EXCHANGE_WASM_BYTES => "../res/ref-router_release.wasm",
}
